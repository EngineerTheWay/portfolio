...
Personal portfolio and blog — case studies, professional insights, and career background.

**Live:** [calebway.io](https://calebway.io) · **Case study:** [How this site was built](https://calebway.io/projects/portfolio/)

> Forked from [guihubie's Astro template](https://github.com/guihubie/free-astro-template).

Built with Astro, TypeScript and Tailwind CSS, deployed to Cloudflare. The template shipped with a working blog but handled projects as a hardcoded array with no detail pages, so most of the work went into replacing that with a real content collection, then building the reading, navigation and UI/UX pieces around it.
...
- Improved blog system with cleaner navigation and pagination

## Deployment

- Hosted on **Cloudflare** via the Astro Cloudflare adapter
- Automated builds triggered from GitHub `main`
- Astro 5.18, with the MDX, RSS and sitemap integrations
